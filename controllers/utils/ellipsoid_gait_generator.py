...
class EllipsoidGaitGenerator():
    ...
    def __init__(self, robot, time_step):
        ...
        self.robot_height_offset = 0.29  # desired height for the robot's center of mass
        self.lateral_leg_offset = 0.06  # y distance between the center of mass and one foot
        self.step_period = 0.3  # 0.4  # time to complete one step
        ...
        self.step_height = 0.015 # 0.04  # height of the ellipsoid path
