...
class EllipsoidGaitGenerator():
    ...
    def __init__(self, robot, time_step):
        ...
        self.lateral_leg_offset = 0.055  # y distance between the center of mass and one foot
        self.step_period = 0.38  # 0.4  # time to complete one step
        ...
        self.step_height = 0.008 # 0.04  # height of the ellipsoid path
